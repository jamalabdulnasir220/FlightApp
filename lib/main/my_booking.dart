...
import '../otherScreens/bus_ticket_screen.dart';
...
class _MyBookingState extends State<MyBooking> {
  ...
  ValueNotifier<List<Ticket>?> _ticketsList = ValueNotifier<List<Ticket>?>([]);
  ...
  getTicketData({isRefresh = false}) async {
    if (isRefresh) {
